        ...
        while len(self.executed_gates) < len(dag.nodes):
            ...
            for node in candidates:
                ...
                # ====================================================
                    ...
                    CONGESTION_THRESHOLD = 15  # 이보다 오래 기다려야 하면 새 공장 짓기 고려
                    ...
                    distill_finish, magic_error = target_factory.start_distillation(start_time)
                    
                    # 이동 거리 (Manhattan)
                    distance = abs(target_factory.x - qx) + abs(target_factory.y - qy)
                    transport_time = distance * Configuration.CODE_DISTANCE
                    ...
                    ideal_duration = Configuration.get_logical_cycle_duration(10) # 15-to-1 time
